...
public class MathUtils {
    ...
    /**
     * Creates a sine wave between two points.
     * @param value The value you'd like to measure at.
     * @param minimum The minimum bound for the wave.
     * @param maximum The maximum bound for the wave.
     * @return The result of the bounded sine wave at the value.
     */
    public static float boundedSin (float value, float minimum, float maximum) {
        return ((MathHelper.sin(value) + 1) / 2) * (maximum - minimum) + minimum;
    }
    ...
    /**
     * Get a random integer float between two numbers. Rather self-explanatory.
     * @param rand The RNG used to determine the float.
     * @param min The minimum value of the random number.
     * @param max The maximum value of the random number.
     * @return A random integer between the minimum and the maximum.
     */
    public static int getRandomIntegerBetween (Random rand, int min, int max) {
